...
public class PhobosOffhand extends Module
{
    ...
    public PhobosOffhand() {
        super("PhobosOffhand", "Allows you to switch up your Offhand.", Category.COMBAT, true, false, false);
        ...
        PhobosOffhand.instance = this;
    }
    
    public static PhobosOffhand getInstance() {
        if (PhobosOffhand.instance == null) {
            PhobosOffhand.instance = new PhobosOffhand();
        }
        return PhobosOffhand.instance;
    }
    
    public void onItemFinish(final ItemStack stack, final EntityLivingBase base) {
        if (this.noOffhandGC.getValue() && base.equals((Object)PhobosOffhand.mc.player) && stack.getItem() == Offhand.mc.player.getHeldItemOffhand().getItem()) {
        ...
        if (this.shouldTotem()) {
            ...
            for (int i = 45; i > 0; --i) {
                if (Offhand.mc.player.inventory.getStackInSlot(i).getItem() instanceof ItemBlock) {
                    if (((ItemBlock)Offhand.mc.player.inventory.getStackInSlot(i).getItem()).getBlock() == Blocks.OBSIDIAN) {
                        size += Offhand.mc.player.inventory.getStackInSlot(i).getCount();
                    }
                }
            }
            ...
            for (int i = 45; i > 0; --i) {
                if (Offhand.mc.player.inventory.getStackInSlot(i).getItem() instanceof ItemBlock) {
                    if (((ItemBlock)Offhand.mc.player.inventory.getStackInSlot(i).getItem()).getBlock() == Blocks.WEB) {
                        size += Offhand.mc.player.inventory.getStackInSlot(i).getCount();
                    }
                }
            }
    ...
    public void doSwitch(final boolean b) {
    }
